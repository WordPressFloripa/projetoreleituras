...
?>
<article id="post-<?php the_ID(); ?>" <?php post_class( array( 'list-article', 'clearfix', 'wow', 'slideInUp' ) ); ?>>
	<?php if ( $show_thumbnail ) { ?>
	<div class="list-article-thumb wow">
		<a href="<?php echo esc_url( get_permalink() ); ?>">
			<?php
			if ( has_post_thumbnail() ) {
				the_post_thumbnail( 'img-lista-audiolivros' );
			} else {
